  ...
  return (
    ...
    >
      ...
      <p className="mt-4 mb-10 text-xl text-muted-foreground">
        Đội ngũ K17.3 của FPLHN-FACTORY là những người tiên phong, đặt nền móng
        cho sự phát triển và đổi mới tại xưởng. Họ mang trong mình tinh thần học
        hỏi không ngừng và nhiệt huyết sáng tạo, dẫn dắt các dự án đột phá và
        xây dựng một cộng đồng công nghệ đầy cảm hứng. Khóa 17.3 không chỉ là
        những người mở đường mà còn là hình mẫu cho những khóa tiếp theo trong
